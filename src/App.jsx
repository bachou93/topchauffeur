...
const STRIPE_LINKS = {
  orly: "https://buy.stripe.com/5kQ14n08H7cv8GR1SvgA800",
  cdg:  "https://buy.stripe.com/fZu14n3kT2Wf4qB2WzgA801",
  paris: "https://buy.stripe.com/cNi7sL08H40j4qB0OrgA802"
};

function getStripeLink(fromAddress, toAddress) {
  const fa = detectAirport(fromAddress);
  const ta = detectAirport(toAddress);
  if (fa === "orly" || ta === "orly") return STRIPE_LINKS.orly;
  if (fa === "cdg"  || ta === "cdg")  return STRIPE_LINKS.cdg;
  return STRIPE_LINKS.paris;
}
